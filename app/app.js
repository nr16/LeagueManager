...
app.config(function ($routeProvider) {
	$routeProvider
      ...
      .when('/Player', { templateUrl: 'app/components/Player/Player.html' })
      .when('/PlayerDetails/:playerId', { templateUrl: 'app/components/Player/PlayerDetails.html', controller: 'PlayerDetailsCtrl' })
